...
is_gui = 'streamlit' in sys.argv[0] or 'streamlit run' in ' '.join(sys.argv)
...
if is_gui:
    ...
    # YOUR FULL CSS HERE (paste your CSS block)
    # ==========================================
    ...
    # CONSOLE MODE - No Streamlit imports
    from controller import Controller
    from input_handler import InputHandler
    ...
    print("2. Run automated test suite (runs basic tests)")
    print("3. Exit")
    print("-"*50)
